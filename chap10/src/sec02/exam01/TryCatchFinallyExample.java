...
//			Class clazz = Class.forName("java.lang.String"); // 주어진 이름으로 클래스를 찾아서 Class 객체로 반환
			...
			// 클래스를 못 찾았을 때
			Class clazz = Class.forName("java.lang.String2"); // java.lang.밑에 String2는 없음
			
			System.out.println("클래스를 찾았습니다.");
		} catch (ClassNotFoundException e) { // 이 예외보다 높은 상위타입의 예외를 적어도 상관X
			// 예외가 발생했을 때 처리할 코드가 들어감
