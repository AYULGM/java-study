...
public class UUIDExample {
	...
	public static void main(String[] args) {
		...
		String extension = originalName.substring(originalName.lastIndexOf(".")); // 뒤에서부터 추출하는 lastIndexOf 덕분에 .png가 추출됨
		String savedName = UUID.randomUUID().toString() + extension; // 랜덤 UUID값을 String 형식으로 저장하고 .png를 덧붙임
		
		File dest = new File(uploadDir, savedName); // uploadDir 디렉토리안에 savedName이라는 파일경로를 만들어 dest라는 File 객체로 참조한다.
