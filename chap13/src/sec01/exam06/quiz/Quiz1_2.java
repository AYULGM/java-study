...
//		System.out.println("Tom=" + map.get("Tom"));  이렇게 안써도 그냥 syso에 map 넣으면 toString으로 재정의한거 다 나옴
//		System.out.println("John=" + map.get("John"));
//		System.out.println("Emma=" + map.get("Emma"));
...
//        john.setSalary(4100000);
        // 변수안쓰고 map.get("John").setSalary(4100000); 이렇게 해도됨
