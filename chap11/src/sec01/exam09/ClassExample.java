...
public class ClassExample {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		// 방법2
		Class c2 = Class.forName("sec01.exam09.Car"); //예외 떠넘기기 (throws)
		...
		System.out.println(c1.getPackage().getName()); // 패키지이름
		System.out.println(c1.getPackageName()); // 위 코드와 동일 (자바9 부터 추가)
