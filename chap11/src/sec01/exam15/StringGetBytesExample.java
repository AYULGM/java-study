...
public class StringGetBytesExample {
	...
	public static void main(String[] args) {
			...
			byte[] bytes1 = str.getBytes(); // 문자셋을 지정하지 않았기때문에 시스템의 기본 문자셋을 사용
			...
			try {
				...
				// 특정 문자셋으로 디코딩
				String str3 = new String(bytes3, "EUC-KR"); // 인코딩 시 사용한 문자셋과 다르게
				System.out.println("bytes3->String: " + str3); // 3바이트짜리로 인코딩하고 2바이트로 디코딩하려니 글자깨짐
