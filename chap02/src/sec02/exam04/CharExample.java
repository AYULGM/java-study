...
//		char cc = -65; // 음수값 저장 안됨, 유니코드는 0부터 시작
		...
		//선생님이 byte , short , char 등의 int이하의 타입들은 연산을할때 int로 승격해버림
		
		// 이런 방식은 문자를 숫자로 변환할 때 쓰일 수 있음
		char digit = '8';
		int numericValue = digit - '0'; // 56 - 48
...
//선생님이 String은 .class 타입이라 class타입은 대문자로 시작해야된대서 String할때 대문자로 시작한대
	}
}
